!(function (e) {
  ...
  e(".multi-side-hover").each(function () {
    ...
    e("nav#dropdown").meanmenu({
      siteLogo:
        "<div class='mobile-menu-nav-back'><a class='logo-mobile' href='/'><img src='/templates/ayziya/assets/img/logo.png' alt='logo' class='img-fluid'/></a></div>",
    }),
  ...
  e(".rc-carousel").each(function () {
    ...
    var z = a.data("owlCarousel");
    if (N) {
      d = e(N);
      var A = e(".rt-next", d),
        I = e(".rt-prev", d);
      A.on("click", function (e) {
        return e.preventDefault(), z.next(), !1;
      }),
        I.on("click", function (e) {
          return e.preventDefault(), z.prev(), !1;
        });
    }
  }),
    ...
    e(window).on("scroll", function () {
      var a,
        ...
        s = e(window).width(),
        r = t.parent("#header-two"),
        l = t.parent("#header-one"),
        d =
          (l.find(".header-top-bar").outerHeight(), t.prev(".header-top-bar"));
      s > 991 &&
        (n.css("padding-top", ""),
        r.length
          ? (a = o = 1)
          : l.length &&
            i <= (a = d.outerHeight()) &&
            l.hasClass("header-fixed") &&
            l.css("top", "-" + i + "px"),
        i >= a
          ? ((l.length || r.length) && t.addClass("stick"),
            l.length &&
              (l.hasClass("header-fixed")
                ? l.css("top", "-" + a + "px")
                : n.css("padding-top", o + "px")))
          : (t.removeClass("stick"), l.length && n.css("padding-top", 0)));
    });
})(jQuery);
